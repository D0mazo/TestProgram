...
?>
    ...
    <div class="text-center mb-4">
        ...
        <div class="progress results-progress mx-auto mt-2">
            <div class="progress-bar results-progress-bar"
                 style="width:<?= $pct ?>%"
...
<?php foreach ($answers as $i => $row):
    ...
    <div class="answer-row <?= $correct ? 'correct' : 'incorrect' ?>">
        ...
        <p class="fw-semibold mb-2 question-text"><?= e($row['question_text']) ?></p>
        <div class="d-flex flex-wrap gap-2">
            <?php foreach ($opts as $letter => $text):
                ...
                ?>
                <span class="badge px-3 py-2 border answer-badge <?= $badge ?>">
            <?= $letter ?>. <?= e($text) ?>
